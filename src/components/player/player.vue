            ...
            <div class="bottom">
                ...
                <div class="operators">
                    ...
                    <div class="icon i-center">
                        <i :class="playIcon" @click="triggerPlay"></i>
                    </div>
                    <div class="icon i-right">
                        <i class="icon-next" @click="next"></i>
                    </div>
                    <div class="icon i-right">
                        <i class="icon" :class="getIcon(currentSong)" @click="triggerLove(currentSong)" ></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mini-player" v-show="!fullScreen" @click="open">
            ...
            <div class="control">
                <progress-circle :radius="32" :percent="percent">
                    <i class="icon-mini" :class="miniPlayIcon"  @click.stop="triggerPlay"></i>                 
                </progress-circle>
            </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        watch:{
            currentSong(newSong,oldSong){//歌曲变化时自动播放
